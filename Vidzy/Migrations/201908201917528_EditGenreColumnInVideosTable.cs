namespace Vidzy.Migrations
{
    ...
    public partial class EditGenreColumnInVideosTable : DbMigration
    {
        public override void Up()
        {
            ...
            AddColumn("dbo.Videos", "VideoGenre_Id", c => c.Byte());
            CreateIndex("dbo.Videos", "VideoGenre_Id");
            AddForeignKey("dbo.Videos", "VideoGenre_Id", "dbo.Genres", "Id");
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Videos", "VideoGenre_Id", "dbo.Genres");
            DropIndex("dbo.Videos", new[] { "VideoGenre_Id" });
            DropColumn("dbo.Videos", "VideoGenre_Id");
